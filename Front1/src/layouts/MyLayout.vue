<template>
  <q-layout view="hHh lpR fFf">
    ...
    <!-- <q-header reveal elevated class="bg-grey-9 text-white">
      <q-toolbar>
        <q-toolbar-title class="flex align-center justify-between q-pa-xs q-ma-xs">
          <img width="10%" src="../statics/Logo.png">
          <q-toggle color="yellow" label="Тёмная тема" v-model="selection"></q-toggle>
        </q-toolbar-title>
      </q-toolbar>
    </q-header> -->
